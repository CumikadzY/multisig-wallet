...
16. В директории с `walletConnect.py` находится `.env` файл со следующим содержимым:
...
17. В директории с `walletConnect.py` находится тот же `.env` файл, что и на шаге 16. После запуска команды:
    ```
    $ walletConnect.py confirm <0xaction id from the step 7>
    ```
    в терминале выводится 
...
18. В директории с `walletConnect.py` находится `.env` файл со следующим содержимым:
